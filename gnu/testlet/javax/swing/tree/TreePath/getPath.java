...
/**
 * Some tests for the getPath() method in the {@link TreePath} class.
 */
public class getPath implements Testlet 
{
  ...
  public void test(TestHarness harness)      
  {
    ...
    // if we update the returned array, does the original path change?
    o1[0] = "Y";
    harness.check(p1.getLastPathComponent(), "X");
  }
