...
/**
 * Checks whether the DefaultBoundedRangeModel.getValueIsAdjusting
  ...
  implements Testlet
{
  public void test(TestHarness harness)
  {
    ...
    harness.check(dbrm.getValueIsAdjusting() == false);

    // Check #2.
    dbrm.setRangeProperties(3, 2, -4, 10, true);
    harness.check(dbrm.getValueIsAdjusting() == true);
  }
}
