...
/**
 * Some checks for the setMaximum() method in the {@link JSlider} class.
 */
public class setMaximum implements Testlet {
  ...
  public void test(TestHarness harness)      
  {
    ...
    harness.check(listener2.event.getPropertyName(), "maximum");
