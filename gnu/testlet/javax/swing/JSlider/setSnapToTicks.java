...
/**
 * Some checks for the setSnapToTicks() method in the {@link JSlider} class.
 */
public class setSnapToTicks implements Testlet {
  ...
  public void test(TestHarness harness)      
  {
    ...
    harness.check(listener2.event.getPropertyName(), "snapToTicks");
