...
/**
 * Some checks for the setPaintTicks() method in the {@link JSlider} class.
 */
public class setPaintTicks implements Testlet {
  ...
  public void test(TestHarness harness)      
  {
    ...
    harness.check(listener2.event.getPropertyName(), "paintTicks");
