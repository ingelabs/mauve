...
public class getLayoutAlignmentY implements Testlet
{
  ...
  void testWithoutChildren(TestHarness h)
  {
    ...
    h.check(l.getLayoutAlignmentY(c), 0.0F);
  }
  ...
  void testWithOneChild(TestHarness h)
  {
    ...
    c.add(c1);
    OverlayLayout l = new OverlayLayout(c);
    h.check(l.getLayoutAlignmentY(c), 0.5F);
  }
  ...
  void testWithAlignment(TestHarness h)
  {
    ...
    c.add(c3);
    OverlayLayout l = new OverlayLayout(c);
    h.check(l.getLayoutAlignmentY(c), 0.6666666865348816F);
  }
  ...
  void testWrongContainer(TestHarness h)
  {
    ...
    try
      {
        h.check(l.getLayoutAlignmentY(c2), 0.5F);
