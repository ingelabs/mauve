  ...
  implements Testlet
{
  public void test(TestHarness harness)
  {
    ...
    // Check #1.
    harness.check(mgr.getUndoOrRedoPresentationName(), "UndoPres2");

    // Check #2.
    mgr.undo();
    harness.check(mgr.getUndoOrRedoPresentationName(), "RedoPres2");
    ...
    // Check #5.
    mgr.end();
    harness.check(mgr.getUndoOrRedoPresentationName(), "UndoPres1");
    ...
    try
      {
        ...
        harness.check(mgr.getUndoOrRedoPresentationName(), "Foondo");
      }
    finally
      {
