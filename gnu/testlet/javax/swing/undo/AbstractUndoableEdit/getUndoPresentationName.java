...
/**
 * Checks whether the AbstractUndoableEdit.getUndoPresentationName method
 * works correctly.
 *
  ...
  implements Testlet
{
  public void test(TestHarness harness)
  {
    ...
    harness.check(edit.getUndoPresentationName(), "UndoFoo Action");

    // Check #2.
    edit = new AbstractUndoableEdit();
    harness.check(edit.getUndoPresentationName(), "UndoFoo");
