...
/**
 * Checks if SimpleAttributeSet's containsAttribute method
 * checks its resolve parent's map if the attribute is not 
 * found locally.
 */
public class containsChecksParent implements Testlet
{
