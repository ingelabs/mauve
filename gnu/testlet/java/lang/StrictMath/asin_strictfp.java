...
/**
  * Test for a static method StrictMath.asin()
  * by using strictfp modifier.
  */
public strictfp class asin_strictfp implements Testlet
{
  /**
  ...
  /**
   * These values are used as arguments to compute asin using StrictMath.
   */
