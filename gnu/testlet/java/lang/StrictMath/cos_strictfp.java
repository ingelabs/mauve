...
/**
  * Test for a static method StrictMath.cos()
  * by using strictfp modifier.
  */
public strictfp class cos_strictfp implements Testlet
{
  /**
  ...
  /**
   * These values are used as arguments to compute cos using StrictMath.
   */
  ...
  private static double[] outputValues =
    {
      ...
      1.0,                   // 0.0
      0.7071067811865476,    // StrictMath.PI/4
      6.123233995736766E-17, // StrictMath.PI/2
      -1.0,                  // StrictMath.PI
      1.0,                   // 2*StrictMath.PI
      1.0,                   // 4*StrictMath.PI
      1.0,                   // 100*StrictMath.PI
