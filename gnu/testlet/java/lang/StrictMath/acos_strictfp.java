...
/**
  * Test for a static method StrictMath.acos()
  * by using strictfp modifier.
  */
public strictfp class acos_strictfp implements Testlet
{
  /**
  ...
  /**
   * These values are used as arguments to compute acos using StrictMath.
   */
