...
/**
  * Test for a static method StrictMath.tan()
  */
public class tan implements Testlet
{
  /**
  ...
  /**
   * These values are used as arguments to compute tan using StrictMath.
   */
  ...
  private static double[] outputValues =
    {
      ...
      Double.NaN,              // Infinity
      Double.NaN,              // -Infinity
      -0.004962015874444895,   // Double.MAX_VALUE
      4.9E-324,                // Double.MIN_VALUE
      0.0,                     // 0.0
      0.9999999999999999,      // StrictMath.PI/4
      1.633123935319537E16,    // StrictMath.PI/2
