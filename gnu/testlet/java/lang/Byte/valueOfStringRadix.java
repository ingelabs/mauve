// Test of Byte method valueOf(String, radix).
...
/**
 * Test the method Byte.valueOf(String, radix);
 */
public class valueOfStringRadix implements Testlet
{
  public void test (TestHarness harness)
  {
    harness.check(Byte.valueOf("0", 2).equals(new Byte((byte)0)));
    harness.check(Byte.valueOf("0", 10).equals(new Byte((byte)0)));
    harness.check(Byte.valueOf("0", 16).equals(new Byte((byte)0)));
    harness.check(Byte.valueOf("0", 36).equals(new Byte((byte)0)));

    harness.check(Byte.valueOf("10", 2).equals(new Byte((byte)2)));
    harness.check(Byte.valueOf("10", 10).equals(new Byte((byte)10)));
    harness.check(Byte.valueOf("10", 16).equals(new Byte((byte)16)));
    harness.check(Byte.valueOf("10", 36).equals(new Byte((byte)36)));

    harness.check(Byte.valueOf("z", 36).equals(new Byte((byte)35)));
