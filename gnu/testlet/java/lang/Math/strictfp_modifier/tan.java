...
/**
  * Test for a static method Math.tan()
  * by using strictfp modifier.
  */
public strictfp class tan implements Testlet
{
  /**
  ...
  /**
   * These values are used as arguments to compute tan using Math.
   */
  ...
  private static double[] outputValues =
    {
      ...
      0.0,                     // 0.0
      0.9999999999999999,      // Math.PI/4
      1.633123935319537E16,    // Math.PI/2
