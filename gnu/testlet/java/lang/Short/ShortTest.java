...
public class ShortTest implements Testlet
{
  ...
  protected static TestHarness harness;
	public void test_Basics()
	{
		...
		try {
		if ( (new Short("-FF")).shortValue() != -255 )
		...
		if ( Short.decode( "123").shortValue() != 123 )
			harness.fail("Error: test_Basics failed - 6" );
		if ( Short.decode( "32767").shortValue() != 32767 )
	...
	{
		if ( !( new Short((short)123)).toString().equals("123"))
			harness.fail("Error: test_toString failed - 1" );
		if ( !( new Short((short)-44)).toString().equals("-44"))
			harness.fail("Error: test_toString failed - 2" );

		if ( !Short.toString((short) 234 ).equals ("234" ))
			harness.fail("Error: test_toString failed - 3" );
		if ( !Short.toString((short) -34 ).equals ("-34" ))
	...
	public void test_equals()
	{
		...
		if ( !i1.equals( new Short((short)23)))
			harness.fail("Error: test_equals failed - 1" );
		if ( !i2.equals( new Short((short)-23)))
	...
	{
		if ( Short.valueOf("21234").intValue() != Short.parseShort("21234"))
