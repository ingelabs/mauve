...
/**
 * Checks whether the CubicCurve2D.Float.getCtrlP1() method works
 * correctly.
 *
  ...
  implements Testlet
{
  public void test(TestHarness harness)
  {
    ...
    curve = new CubicCurve2D.Float(-1, -2, -3.141f, 42, -5, -6, -77, 88);
    harness.check(curve.getCtrlP1().getX(), -3.141f); // Check 1
