...
/**
 * Some tests for the intersect() method in the {@link Rectangle2D} class.
 */
  ...
  implements Testlet
{
  ...
  public void test(TestHarness harness)
  {
    ...
    Rectangle2D r2 = new Rectangle2D.Double(2.0, 1.0, 3.0, 4.0);
    Rectangle2D r3 = new Rectangle2D.Double();
    Rectangle2D.intersect(r1, r2, r3);
    harness.check(r3.getX(), 2.0);
    harness.check(r3.getY(), 2.0);
    harness.check(r3.getWidth(), 2.0);
    harness.check(r3.getHeight(), 3.0);
